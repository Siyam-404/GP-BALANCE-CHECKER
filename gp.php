...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <button type="button" class="btn btn-join" onclick="window.open('https://t.me/Team_X_Unknwon/', '_blank')">Join Channel</button>
        </form>
        ...
        if (isset($_POST['submit'])) {
            $number = $_POST['number'];
            $api_url = "https://mharmy.xyz/gp.php?msisdn=" . urlencode($number);
